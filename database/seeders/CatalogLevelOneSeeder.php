...
class CatalogLevelOneSeeder extends Seeder
{
    public $data = [
        [
            ...
            'image_licence_link' => 'https://ru.freepik.com/free-photo/baked-pork-decorated-with-arugula-leaves_6850619.htm#page=14&query=meat&position=12&from_view=search&track=sph',
            'link' => 'meat',
            'order' => 1,
