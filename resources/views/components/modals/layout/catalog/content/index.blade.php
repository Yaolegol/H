<div class="modules-common-catalog-content">
    @foreach($catalog as $catalogItem)
        <div
            class="modules-common-catalog-content__item j-components-catalog-content-item"
        ...
        >
            ...
            <div class="modules-common-catalog-content__categories-container">
                @foreach( $catalogItem['catalog_level_two'] as $contentData )
                    <div
                        class="modules-common-catalog-content__category-item j-components-catalog-content-item__category"
