        ...
        <div class="components-modals-base-common__body-container">
            <div class="components-modals-base-common__body">
                <div class="components-modals-base-common__close-button-container">
                    <button
                        class="components-modals-base-common__close-button j-components-modals-base-common__close-button"
                        type="button"
                    >
                        @include('icons.close')
                    </button>
                </div>
                <div class="components-modals-base-common__content-container j-components-modals-base-common__content-container"></div>
            </div>
        </div>
    </div>
</div>
