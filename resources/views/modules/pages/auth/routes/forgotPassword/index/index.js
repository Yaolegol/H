...
import 'views/modules/pages/auth/routes/forgotPassword/components/confirmCode';
import 'views/modules/pages/auth/routes/forgotPassword/components/sendSms';
import './index.less';
...
class ForgotPassword {
    ...
    sendConfirmCode = async (data) => {
        const response = await fetch('/forgot-password/confirmCode', {
    ...
    sendSms = async (data) => {
        const response = await fetch('/forgot-password/sendSms', {
            body: JSON.stringify(data),
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json',
...
module.initModule('j-modules-pages-auth-routes-forgot-password-index', ForgotPassword);
