<div class="modules-common-location-components-choose-info-block-item j-location-common-open-modal-button">
    ...
    <div class="modules-common-location-components-choose-info-block-item__buttons-container">
        <button class="modules-common-location-components-choose-info-block-item__change-button j-location-common-open-modal-button__button">
            {{$buttonText}}
        </button>
        <button
            class="modules-common-location-components-choose-info-block-item__reset-button j-location-common-open-modal-button__button-reset"
            type="button"
        >
            сбросить
        </button>
