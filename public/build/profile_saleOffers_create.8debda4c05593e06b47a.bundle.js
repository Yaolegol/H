...
/******/ 	deferredModules.push(["./resources/views/pages/profile/sale-offers/create/index.js","vendors"]);
...
/***/ "./resources/views/components/checkboxes/map/index.js":
/*!************************************************************!*\
  !*** ./resources/views/components/checkboxes/map/index.js ***!
  \************************************************************/
/*! no exports provided */
...
/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var helpers_events__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! helpers/events */ "./resources/helpers/events.js");
/* harmony import */ var _index_less__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./index.less */ "./resources/views/components/checkboxes/map/index.less");
...
var CheckboxesMap = /*#__PURE__*/_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(function CheckboxesMap(element) {
  var _this = this;

  _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_2___default()(this, CheckboxesMap);

  _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(this, "bind", function () {
    if (_this.withCoords) {
      Object(helpers_events__WEBPACK_IMPORTED_MODULE_4__["addEventListener"])(_this.module, 'change', _this.handleChange);
    }
  });

  _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(this, "handleChange", function (e) {
    var target = e.target;
    var isInput = target.classList.contains('j-checkboxes-map__input');
  ...
  _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(this, "sendInitialMessage", function () {
    if (_this.isChecked && _this.withCoords) {
      _this.sendMessage({
        isChecked: _this.input.checked,
        value: _this.input.value
      });
    }
  });

  _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(this, "sendMessage", function () {
...
var list = _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(document.querySelectorAll('.j-checkboxes-map'));
...
/***/ "./resources/views/components/checkboxes/map/index.less":
/*!**************************************************************!*\
  !*** ./resources/views/components/checkboxes/map/index.less ***!
  \**************************************************************/
/*! no static exports found */
...
/***/ "./resources/views/components/inputs/file/item/index.js":
/*!**************************************************************!*\
  !*** ./resources/views/components/inputs/file/item/index.js ***!
  \**************************************************************/
/*! no exports provided */
...
/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var helpers_events__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! helpers/events */ "./resources/helpers/events.js");
/* harmony import */ var _index_less__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./index.less */ "./resources/views/components/inputs/file/item/index.less");
/* harmony import */ var _index_less__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_index_less__WEBPACK_IMPORTED_MODULE_5__);
...
var InputsFileItem = /*#__PURE__*/_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(function InputsFileItem(element) {
  var _this = this;

  _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_2___default()(this, InputsFileItem);

  _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(this, "addFilePreview", function (src) {
    var image = "\n            <img\n                alt=\"\"\n                class=\"components-inputs-file-item__image\"\n                src=\"".concat(src, "\"\n            >\n        ");
    _this.imageContainer.innerHTML = image;
  });

  _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(this, "addRemoveInput", function () {
    var input = "\n            <input name=\"remove_".concat(_this.inputName, "\" type=\"hidden\" />\n        ");

    _this.module.insertAdjacentHTML('afterbegin', input);
  });

  _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(this, "bind", function () {
    Object(helpers_events__WEBPACK_IMPORTED_MODULE_4__["addEventListener"])(_this.input, 'change', _this.handleInputChange);
    Object(helpers_events__WEBPACK_IMPORTED_MODULE_4__["addEventListener"])(_this.changeFileButton, 'click', _this.handleChangeFileButtonClick);
    Object(helpers_events__WEBPACK_IMPORTED_MODULE_4__["addEventListener"])(_this.removeFileButton, 'click', _this.handleRemoveFileButtonClick);
  });

  _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(this, "handleChangeFileButtonClick", function (e) {
    _this.input.click();
  });

  _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(this, "handleInputChange", function (e) {
    var file = e.target.files[0];

    if (_this.withPreviewFile) {
      if (file) {
        var src = URL.createObjectURL(file);

        _this.addFilePreview(src);
  ...
  _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(this, "handleRemoveFileButtonClick", function (e) {
    _this.input.value = '';

    _this.hideContent();

    _this.addRemoveInput();
  });

  _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(this, "hideContent", function () {
    _this.module.classList.remove('components-inputs-file-item_with-image');
  });

  _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(this, "showContent", function () {
    _this.module.classList.add('components-inputs-file-item_with-image');
  });
...
var list = _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(document.querySelectorAll('.j-inputs-file-item'));
...
/***/ "./resources/views/components/inputs/file/item/index.less":
/*!****************************************************************!*\
  !*** ./resources/views/components/inputs/file/item/index.less ***!
  \****************************************************************/
/*! no static exports found */
...
/***/ "./resources/views/components/inputs/radio/group-first-level/index.js":
/*!****************************************************************************!*\
  !*** ./resources/views/components/inputs/radio/group-first-level/index.js ***!
  \****************************************************************************/
/*! no exports provided */
...
/* harmony import */ var views_components_inputs_radio_group_second_level__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! views/components/inputs/radio/group-second-level */ "./resources/views/components/inputs/radio/group-second-level/index.js");
/* harmony import */ var views_components_inputs_radio_item__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! views/components/inputs/radio/item */ "./resources/views/components/inputs/radio/item/index.js");
/* harmony import */ var _index_less__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./index.less */ "./resources/views/components/inputs/radio/group-first-level/index.less");
...
var CHANGE = events_index__WEBPACK_IMPORTED_MODULE_4__["EVENTS_NAMES"].INPUTS.RADIO.GROUP.CHANGE;

var InputsRadioGroupFirstLevel = /*#__PURE__*/_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(function InputsRadioGroupFirstLevel(element) {
  var _this = this;

  _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_2___default()(this, InputsRadioGroupFirstLevel);
  ...
  _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(this, "handleClick", function (e) {
    ...
    var isSameValue = _this.value === value;
  ...
  Object(helpers_events__WEBPACK_IMPORTED_MODULE_5__["addEventListener"])(this.module, 'click', this.handleClick);
  this.init();
});

var list = _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(document.querySelectorAll('.j-inputs-radio-group-first-level'));
...
/***/ "./resources/views/components/inputs/radio/group-first-level/index.less":
/*!******************************************************************************!*\
  !*** ./resources/views/components/inputs/radio/group-first-level/index.less ***!
  \******************************************************************************/
/*! no static exports found */
...
/***/ "./resources/views/components/inputs/radio/group-second-level/index.js":
/*!*****************************************************************************!*\
  !*** ./resources/views/components/inputs/radio/group-second-level/index.js ***!
  \*****************************************************************************/
/*! no exports provided */
...
/* harmony import */ var events_index__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! events/index */ "./resources/events/index.js");
/* harmony import */ var helpers_events__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! helpers/events */ "./resources/helpers/events.js");
/* harmony import */ var views_components_inputs_radio_item__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! views/components/inputs/radio/item */ "./resources/views/components/inputs/radio/item/index.js");
/* harmony import */ var _index_less__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./index.less */ "./resources/views/components/inputs/radio/group-second-level/index.less");
...
var InputsRadioGroupSecondLevel = /*#__PURE__*/_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(function InputsRadioGroupSecondLevel(element) {
  var _this = this;

  _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_2___default()(this, InputsRadioGroupSecondLevel);

  _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(this, "getContentContainersMap", function () {
    return _this.contentContainerList.reduce(function (acc, contentContainer) {
      var id = contentContainer.dataset.listenId;
      return _objectSpread(_objectSpread({}, acc), {}, _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()({}, id, contentContainer));
    }, {});
  });
  ...
  _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(this, "handleChange", function (e) {
    ...
    if (groupName !== _this.listenGroupName) {
      return;
    }

    var contentContainer = _this.contentContainersMap[value];

    if (!contentContainer) {
      _this.module.classList.add('components-inputs-radio-group-second-level_hidden');

      if (_this.activeContentContainer) {
        _this.activeContentContainer.classList.remove('components-inputs-radio-group-second-level__content-container_active');
      }

      return;
    }

    _this.module.classList.remove('components-inputs-radio-group-second-level_hidden');

    if (_this.activeContentContainer) {
      _this.activeContentContainer.classList.remove('components-inputs-radio-group-second-level__content-container_active');

      var checkedInput = _this.activeContentContainer.querySelector('input:checked');
    ...
    _this.activeContentContainer = contentContainer;

    _this.activeContentContainer.classList.add('components-inputs-radio-group-second-level__content-container_active');
  });

  this.module = element;
  this.contentContainerList = _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(this.module.querySelectorAll('.j-inputs-radio-group-second-level__content-container'));
  ...
  Object(helpers_events__WEBPACK_IMPORTED_MODULE_5__["addEventListener"])(document, CHANGE, this.handleChange);
});

var list = _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(document.querySelectorAll('.j-inputs-radio-group-second-level'));
...
/***/ "./resources/views/components/inputs/radio/group-second-level/index.less":
/*!*******************************************************************************!*\
  !*** ./resources/views/components/inputs/radio/group-second-level/index.less ***!
  \*******************************************************************************/
/*! no static exports found */
...
/***/ "./resources/views/components/inputs/radio/item/index.js":
/*!***************************************************************!*\
  !*** ./resources/views/components/inputs/radio/item/index.js ***!
  \***************************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _index_less__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.less */ "./resources/views/components/inputs/radio/item/index.less");
/* harmony import */ var _index_less__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_index_less__WEBPACK_IMPORTED_MODULE_0__);


/***/ }),

/***/ "./resources/views/components/inputs/radio/item/index.less":
/*!*****************************************************************!*\
  !*** ./resources/views/components/inputs/radio/item/index.less ***!
  \*****************************************************************/
/*! no static exports found */
...
var SearchInput = /*#__PURE__*/_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(function SearchInput(element) {
  var _this = this;

  _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_2___default()(this, SearchInput);

  _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(this, "bind", function () {
    Object(helpers_events__WEBPACK_IMPORTED_MODULE_4__["addEventListener"])(_this.searchInput, 'input', _this.handleInput);
  });
...
var list = _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(document.querySelectorAll('.j-inputs-search'));
...
/***/ "./resources/views/components/inputs/textarea/base/index.js":
/*!******************************************************************!*\
  !*** ./resources/views/components/inputs/textarea/base/index.js ***!
  \******************************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _index_less__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.less */ "./resources/views/components/inputs/textarea/base/index.less");
/* harmony import */ var _index_less__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_index_less__WEBPACK_IMPORTED_MODULE_0__);


/***/ }),

/***/ "./resources/views/components/inputs/textarea/base/index.less":
/*!********************************************************************!*\
  !*** ./resources/views/components/inputs/textarea/base/index.less ***!
  \********************************************************************/
/*! no static exports found */
...
/***/ "./resources/views/components/map/2gis/common/base/index.js":
/*!******************************************************************!*\
  !*** ./resources/views/components/map/2gis/common/base/index.js ***!
  \******************************************************************/
/*! exports provided: Map2gisCommonBase */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Map2gisCommonBase", function() { return Map2gisCommonBase; });
/* harmony import */ var _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/createClass */ "./node_modules/@babel/runtime/helpers/createClass.js");
/* harmony import */ var _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ "./node_modules/@babel/runtime/helpers/classCallCheck.js");
/* harmony import */ var _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @babel/runtime/helpers/defineProperty */ "./node_modules/@babel/runtime/helpers/defineProperty.js");
/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _2gis_maps__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! 2gis-maps */ "./node_modules/2gis-maps/dist/js/script.full.js");
/* harmony import */ var _2gis_maps__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_2gis_maps__WEBPACK_IMPORTED_MODULE_3__);
...
/* harmony import */ var leaflet_markercluster_dist_MarkerCluster_css__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! leaflet.markercluster/dist/MarkerCluster.css */ "./node_modules/leaflet.markercluster/dist/MarkerCluster.css");
...
/* harmony import */ var leaflet_markercluster_dist_MarkerCluster_Default_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! leaflet.markercluster/dist/MarkerCluster.Default.css */ "./node_modules/leaflet.markercluster/dist/MarkerCluster.Default.css");
...
/* harmony import */ var _index_less__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./index.less */ "./resources/views/components/map/2gis/common/base/index.less");
/* harmony import */ var _index_less__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_index_less__WEBPACK_IMPORTED_MODULE_7__);
...
var Map2gisCommonBase = /*#__PURE__*/_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_0___default()(function Map2gisCommonBase(_ref) {
  var _this = this;

  var _center = _ref.center,
      _mapContainer = _ref.mapContainer,
      _markerDataList = _ref.markerDataList,
      _onMapClick = _ref.onMapClick,
      _useMarkerCluster = _ref.useMarkerCluster,
      _zoom = _ref.zoom;

  _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_1___default()(this, Map2gisCommonBase);

  _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2___default()(this, "addMarker", function (_ref2) {
    var lat = _ref2.lat,
        lng = _ref2.lng,
        popupHtml = _ref2.popupHtml;
    var coords = new _2gis_maps__WEBPACK_IMPORTED_MODULE_3___default.a.LatLng(lat, lng);
    var marker = _2gis_maps__WEBPACK_IMPORTED_MODULE_3___default.a.marker(coords);
  ...
  _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2___default()(this, "clearClusterGroup", function () {
    if (_this.clusterGroup) {
      _this.map.removeLayer(_this.clusterGroup);
    }
  });

  _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2___default()(this, "initMap", function (_ref3) {
    var center = _ref3.center,
        mapContainer = _ref3.mapContainer,
        onMapClick = _ref3.onMapClick,
        zoom = _ref3.zoom;
    _this.map = _2gis_maps__WEBPACK_IMPORTED_MODULE_3___default.a.map(mapContainer, {
      center: center,
      zoom: zoom
    });
  ...
  _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2___default()(this, "initMarkers", function (_ref4) {
    var markerDataList = _ref4.markerDataList,
        useMarkerCluster = _ref4.useMarkerCluster;

    if (markerDataList && markerDataList.length) {
      if (useMarkerCluster) {
        _this.clusterGroup = _2gis_maps__WEBPACK_IMPORTED_MODULE_3___default.a.markerClusterGroup();
      }

      markerDataList.forEach(function (markerDataItem) {
        markerDataItem.markersList.forEach(function (makerData) {
          var data = makerData.data,
              markerCoords = makerData.markerCoords;
  ...
  this.initMarkers({
    markerDataList: _markerDataList,
    useMarkerCluster: _useMarkerCluster
  });
});

/***/ }),

/***/ "./resources/views/components/map/2gis/common/base/index.less":
/*!********************************************************************!*\
  !*** ./resources/views/components/map/2gis/common/base/index.less ***!
  \********************************************************************/
/*! no static exports found */
...
/***/ "./resources/views/components/map/2gis/components/add-marker/index.js":
/*!****************************************************************************!*\
  !*** ./resources/views/components/map/2gis/components/add-marker/index.js ***!
  \****************************************************************************/
/*! no exports provided */
...
/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var helpers_events__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! helpers/events */ "./resources/helpers/events.js");
/* harmony import */ var views_components_map_2gis_common_base__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! views/components/map/2gis/common/base */ "./resources/views/components/map/2gis/common/base/index.js");
/* harmony import */ var _index_less__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./index.less */ "./resources/views/components/map/2gis/components/add-marker/index.less");
...
var Map2gisComponentsAddMarker = /*#__PURE__*/_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(function Map2gisComponentsAddMarker(element) {
  var _this = this;

  _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_2___default()(this, Map2gisComponentsAddMarker);

  _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(this, "addInitialMarker", function () {
    if (_this.markerLat && _this.markerLng) {
      _this.addMarkerFromClick(_this.markerLat, _this.markerLng);
    }
  });

  _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(this, "addMarker", function (lat, lng) {
    return _this.mapInstance.addMarker({
      lat: lat,
      lng: lng
    });
  });

  _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(this, "addMarkerFromClick", function (lat, lng) {
    _this.removeMarkerFromClick();

    _this.newMarkerFromClick = _this.addMarker(lat, lng);

    _this.setLatLngInputsValues(lat, lng);
  });

  _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(this, "addMarkerFromCheckbox", function (_ref) {
    var lat = _ref.lat,
        lng = _ref.lng,
        value = _ref.value;

    var markerInstance = _this.addMarker(lat, lng);

    _this.checkboxesMap[value] = markerInstance;
  });

  _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(this, "bind", function () {
    Object(helpers_events__WEBPACK_IMPORTED_MODULE_4__["addEventListener"])(document, 'j-event__need-update-map-marker', _this.handleUpdateMarker);
  });

  _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(this, "handleUpdateMarker", function (e) {
    var detail = e.detail;
  ...
  _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(this, "initMap", function () {
    _this.mapInstance = new views_components_map_2gis_common_base__WEBPACK_IMPORTED_MODULE_5__["Map2gisCommonBase"]({
      center: [62.395570, 104.432320],
      mapContainer: _this.mapContainer,
      markerDataList: [],
      onMapClick: _this.onMapClick,
      zoom: 2
    });
  });

  _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(this, "onMapClick", function (e) {
    var latlng = e.latlng,
        originalEvent = e.originalEvent;
    var lat = latlng.lat,
        lng = latlng.lng;
    var isClickOnMap = originalEvent.target.classList.contains('j-map-2gis-components-add-marker__map-container');

    if (isClickOnMap) {
      _this.addMarkerFromClick(lat, lng);
    } else {
      _this.removeMarkerFromClick();
    }
  });

  _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(this, "removeMarkerFromCheckbox", function (value) {
    var markerInstance = _this.checkboxesMap[value];

    if (markerInstance) {
      markerInstance.removeFrom(_this.mapInstance.map);
    }
  });

  _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(this, "removeMarkerFromClick", function () {
    if (_this.newMarkerFromClick) {
      _this.newMarkerFromClick.removeFrom(_this.mapInstance.map);

      _this.setLatLngInputsValues(0, 0);
    }
  });

  _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(this, "setLatLngInputsValues", function (lat, lng) {
...
var list = _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(document.querySelectorAll('.j-map-2gis-components-add-marker'));
...
/***/ "./resources/views/components/map/2gis/components/add-marker/index.less":
/*!******************************************************************************!*\
  !*** ./resources/views/components/map/2gis/components/add-marker/index.less ***!
  \******************************************************************************/
/*! no static exports found */
...
var Catalog = /*#__PURE__*/_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(function Catalog(_item) {
  ...
  _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(this, "selectNavigationItem", function (id) {
    ...
    if (selectedItem) {
      ...
      _this.selectedNavigationItem.classList.add('components-catalog-navigation-item_active');
    }
  });
  ...
  _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(this, "unselectNavigationItem", function () {
    if (_this.selectedNavigationItem) {
      _this.selectedNavigationItem.classList.remove('components-catalog-navigation-item_active');
    }
  });
...
var SearchCatalog = /*#__PURE__*/_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(function SearchCatalog(_item) {
  var _this = this;
  ...
  _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(this, "checkActiveItem", function () {
    var isSelectedItemHidden = _this.selectedNavigationItem.classList.contains('hidden');

    if (!isSelectedItemHidden) {
      return;
    }

    var navigationItem = _this.navigationItemsList.find(function (element) {
      return !element.classList.contains('hidden');
    });

    if (navigationItem) {
      _this.setActiveItem(navigationItem.dataset.itemId);
    }
  });
  ...
  _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(this, "init", function () {
    ...
    _this.searchData = _this.navigationItemsList.reduce(function (acc, element) {
  ...
  _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(this, "selectContentItem", function (id) {
    var selectedItem = _this.contentItemsList.find(function (item) {
      return item.dataset.itemId === id;
    });
  ...
  _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(this, "selectNavigationItem", function (id) {
    var selectedItem = _this.navigationItemsList.find(function (item) {
      return item.dataset.itemId === id;
    });
  ...
  _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(this, "showAll", function () {
    _this.navigationItemsList.forEach(function (_ref) {
      ...
      var contentElement = content.element,
          categoryList = content.list;
      categoryList.forEach(function (_ref2) {
  ...
  _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(this, "showSearchedItems", function (searchValue) {
    ...
    _this.searchData.forEach(function (_ref3) {
      ...
      categoryList.forEach(function (_ref4) {
      ...
      var isSuit = regexp.test(navigationValue);
...
/***/ "./resources/views/modules/pages/profile/common/components/body/create/index.js":
/*!**************************************************************************************!*\
  !*** ./resources/views/modules/pages/profile/common/components/body/create/index.js ***!
  \**************************************************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _index_less__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.less */ "./resources/views/modules/pages/profile/common/components/body/create/index.less");
/* harmony import */ var _index_less__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_index_less__WEBPACK_IMPORTED_MODULE_0__);


/***/ }),

/***/ "./resources/views/modules/pages/profile/common/components/body/create/index.less":
/*!****************************************************************************************!*\
  !*** ./resources/views/modules/pages/profile/common/components/body/create/index.less ***!
  \****************************************************************************************/
/*! no static exports found */
...
/***/ "./resources/views/modules/pages/profile/common/components/container/file-field/index.js":
/*!***********************************************************************************************!*\
  !*** ./resources/views/modules/pages/profile/common/components/container/file-field/index.js ***!
  \***********************************************************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _index_less__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.less */ "./resources/views/modules/pages/profile/common/components/container/file-field/index.less");
/* harmony import */ var _index_less__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_index_less__WEBPACK_IMPORTED_MODULE_0__);


/***/ }),

/***/ "./resources/views/modules/pages/profile/common/components/container/file-field/index.less":
/*!*************************************************************************************************!*\
  !*** ./resources/views/modules/pages/profile/common/components/container/file-field/index.less ***!
  \*************************************************************************************************/
/*! no static exports found */
...
/***/ "./resources/views/modules/pages/profile/common/components/container/form-field/index.js":
/*!***********************************************************************************************!*\
  !*** ./resources/views/modules/pages/profile/common/components/container/form-field/index.js ***!
  \***********************************************************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _index_less__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.less */ "./resources/views/modules/pages/profile/common/components/container/form-field/index.less");
/* harmony import */ var _index_less__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_index_less__WEBPACK_IMPORTED_MODULE_0__);


/***/ }),

/***/ "./resources/views/modules/pages/profile/common/components/container/form-field/index.less":
/*!*************************************************************************************************!*\
  !*** ./resources/views/modules/pages/profile/common/components/container/form-field/index.less ***!
  \*************************************************************************************************/
/*! no static exports found */
...
/***/ "./resources/views/modules/pages/profile/common/components/container/section/index.js":
/*!********************************************************************************************!*\
  !*** ./resources/views/modules/pages/profile/common/components/container/section/index.js ***!
  \********************************************************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _index_less__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.less */ "./resources/views/modules/pages/profile/common/components/container/section/index.less");
/* harmony import */ var _index_less__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_index_less__WEBPACK_IMPORTED_MODULE_0__);


/***/ }),

/***/ "./resources/views/modules/pages/profile/common/components/container/section/index.less":
/*!**********************************************************************************************!*\
  !*** ./resources/views/modules/pages/profile/common/components/container/section/index.less ***!
  \**********************************************************************************************/
/*! no static exports found */
...
/***/ "./resources/views/modules/pages/profile/common/components/footer/index.js":
/*!*********************************************************************************!*\
  !*** ./resources/views/modules/pages/profile/common/components/footer/index.js ***!
  \*********************************************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _index_less__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.less */ "./resources/views/modules/pages/profile/common/components/footer/index.less");
/* harmony import */ var _index_less__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_index_less__WEBPACK_IMPORTED_MODULE_0__);


/***/ }),

/***/ "./resources/views/modules/pages/profile/common/components/footer/index.less":
/*!***********************************************************************************!*\
  !*** ./resources/views/modules/pages/profile/common/components/footer/index.less ***!
  \***********************************************************************************/
/*! no static exports found */
...
/***/ "./resources/views/modules/pages/profile/routes/sale-offers/create/index.js":
/*!**********************************************************************************!*\
  !*** ./resources/views/modules/pages/profile/routes/sale-offers/create/index.js ***!
  \**********************************************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var views_components_checkboxes_map__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! views/components/checkboxes/map */ "./resources/views/components/checkboxes/map/index.js");
/* harmony import */ var views_components_form_error__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! views/components/form/error */ "./resources/views/components/form/error/index.js");
/* harmony import */ var views_components_inputs_file_item__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! views/components/inputs/file/item */ "./resources/views/components/inputs/file/item/index.js");
/* harmony import */ var views_components_inputs_form__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! views/components/inputs/form */ "./resources/views/components/inputs/form/index.js");
/* harmony import */ var views_components_inputs_radio_group_first_level__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! views/components/inputs/radio/group-first-level */ "./resources/views/components/inputs/radio/group-first-level/index.js");
/* harmony import */ var views_components_inputs_textarea_base__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! views/components/inputs/textarea/base */ "./resources/views/components/inputs/textarea/base/index.js");
/* harmony import */ var views_components_map_2gis_components_add_marker__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! views/components/map/2gis/components/add-marker */ "./resources/views/components/map/2gis/components/add-marker/index.js");
/* harmony import */ var views_modules_pages_profile_common_components_body_create__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! views/modules/pages/profile/common/components/body/create */ "./resources/views/modules/pages/profile/common/components/body/create/index.js");
/* harmony import */ var views_modules_pages_profile_common_components_container_file_field__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! views/modules/pages/profile/common/components/container/file-field */ "./resources/views/modules/pages/profile/common/components/container/file-field/index.js");
/* harmony import */ var views_modules_pages_profile_common_components_container_form_field__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! views/modules/pages/profile/common/components/container/form-field */ "./resources/views/modules/pages/profile/common/components/container/form-field/index.js");
/* harmony import */ var views_modules_pages_profile_common_components_container_section__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! views/modules/pages/profile/common/components/container/section */ "./resources/views/modules/pages/profile/common/components/container/section/index.js");
/* harmony import */ var views_modules_pages_profile_common_components_footer__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! views/modules/pages/profile/common/components/footer */ "./resources/views/modules/pages/profile/common/components/footer/index.js");
/* harmony import */ var views_modules_pages_profile_common_components_header__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! views/modules/pages/profile/common/components/header */ "./resources/views/modules/pages/profile/common/components/header/index.js");
...
/***/ "./resources/views/pages/profile/sale-offers/create/index.js":
/*!*******************************************************************!*\
  !*** ./resources/views/pages/profile/sale-offers/create/index.js ***!
  \*******************************************************************/
/*! no exports provided */
...
/* harmony import */ var views_modules_pages_profile_routes_sale_offers_create__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! views/modules/pages/profile/routes/sale-offers/create */ "./resources/views/modules/pages/profile/routes/sale-offers/create/index.js");
/* harmony import */ var _index_less__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./index.less */ "./resources/views/pages/profile/sale-offers/create/index.less");
/* harmony import */ var _index_less__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_index_less__WEBPACK_IMPORTED_MODULE_3__);
...
/***/ "./resources/views/pages/profile/sale-offers/create/index.less":
/*!*********************************************************************!*\
  !*** ./resources/views/pages/profile/sale-offers/create/index.less ***!
  \*********************************************************************/
/*! no static exports found */
...
/******/ });
//# sourceMappingURL=profile_saleOffers_create.8debda4c05593e06b47a.bundle.js.map