...
/******/ 	deferredModules.push(["./resources/views/pages/admin/offersRating/index.js","vendors"]);
...
/***/ "./resources/views/components/admin/cards/offerRating/index.js":
/*!*********************************************************************!*\
  !*** ./resources/views/components/admin/cards/offerRating/index.js ***!
  \*********************************************************************/
/*! no exports provided */
...
/* harmony import */ var _index_less__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./index.less */ "./resources/views/components/admin/cards/offerRating/index.less");
...
var AdminCard = /*#__PURE__*/_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(function AdminCard(element) {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return fetch("/admin/offers-rating/approve/".concat(_this.offerId), {
              headers: {
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _context4.next = 4;
              return fetch("/admin/offers-rating/reject/".concat(_this.offerId), {
                body: body,
                headers: {
                  'Accept': 'application/json',
                  'Content-Type': 'application/json',
  ...
  this.buttonApprove = this.module.querySelector('.j-components-admin-cards-offer-rating__button-approve');
  this.buttonReject = this.module.querySelector('.j-components-admin-cards-offer-rating__button-reject');
  this.textarea = this.module.querySelector('.j-components-admin-cards-offer-rating__textarea');
  this.init();
  this.bind();
});

helpers_module__WEBPACK_IMPORTED_MODULE_6__["module"].initModule('j-components-admin-cards-offer-rating', AdminCard);

/***/ }),

/***/ "./resources/views/components/admin/cards/offerRating/index.less":
/*!***********************************************************************!*\
  !*** ./resources/views/components/admin/cards/offerRating/index.less ***!
  \***********************************************************************/
...
/***/ "./resources/views/modules/pages/admin/routes/offersRating/index.js":
/*!**************************************************************************!*\
  !*** ./resources/views/modules/pages/admin/routes/offersRating/index.js ***!
  \**************************************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var views_components_admin_cards_offerRating__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! views/components/admin/cards/offerRating */ "./resources/views/components/admin/cards/offerRating/index.js");
...
/* harmony import */ var _index_less__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index.less */ "./resources/views/modules/pages/admin/routes/offersRating/index.less");
...
/***/ "./resources/views/modules/pages/admin/routes/offersRating/index.less":
/*!****************************************************************************!*\
  !*** ./resources/views/modules/pages/admin/routes/offersRating/index.less ***!
  \****************************************************************************/
/*! no static exports found */
...
/***/ "./resources/views/pages/admin/offersRating/index.js":
/*!***********************************************************!*\
  !*** ./resources/views/pages/admin/offersRating/index.js ***!
  \***********************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var views_modules_pages_admin_routes_offersRating__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! views/modules/pages/admin/routes/offersRating */ "./resources/views/modules/pages/admin/routes/offersRating/index.js");
/* harmony import */ var _index_less__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.less */ "./resources/views/pages/admin/offersRating/index.less");
...
/***/ "./resources/views/pages/admin/offersRating/index.less":
/*!*************************************************************!*\
  !*** ./resources/views/pages/admin/offersRating/index.less ***!
  \*************************************************************/
/*! no static exports found */
...
/******/ });
//# sourceMappingURL=admin_offersRating.644e54d2298915896f0d.bundle.js.map