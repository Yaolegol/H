...
/* harmony import */ var _index_less__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./index.less */ "./resources/views/modules/common/map/yandex/components/viewAll/index.less");
...
var MapYandexComponentsViewAll = /*#__PURE__*/_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(function MapYandexComponentsViewAll(element) {
    ...
    _this.offerData.forEach(function (_ref) {
      ...
      markersList.forEach(function (_ref2) {
        ...
        var markerInstance = new ymaps.Placemark([lat, lng], {
          ...
          balloonContentLayout: _this.getBalloonContentLayoutClass()
        });
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _getQueryData = Object(helpers_query__WEBPACK_IMPORTED_MODULE_8__["getQueryData"])(), catalogLevelOneId = _getQueryData.catalogLevelOneId, catalogLevelTwoId = _getQueryData.catalogLevelTwoId;
            bodyData = {
              filter: {
                catalog: {
  ...
  _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_4___default()(this, "getBalloonContentLayoutClass", function () {
    return ymaps.templateLayoutFactory.createClass('<div>{{ properties.title }}</div>' + '<div>Адрес:</div>' + '<div>{{ properties.address }}</div>' + '<div>Телефон:</div>' + '<div>{{ properties.phone }}</div>' + '<div>Цена:</div>' + '<div>{{ properties.price }}</div>' + '<div style="margin-top: 15px"><a href="/offers/{{properties.offerId}}">Подробнее</a></div>');
  });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var views_modules_common_map_yandex_components_viewAll__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! views/modules/common/map/yandex/components/viewAll */ "./resources/views/modules/common/map/yandex/components/viewAll/index.js");
...
/* harmony import */ var views_modules_common_map_common_components_filters_product__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! views/modules/common/map/common/components/filters/product */ "./resources/views/modules/common/map/common/components/filters/product/index.js");
/* harmony import */ var _index_less__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./index.less */ "./resources/views/modules/pages/map/web/routes/index/index.less");
/* harmony import */ var _index_less__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_index_less__WEBPACK_IMPORTED_MODULE_3__);
...
/******/ });
//# sourceMappingURL=map_web_index.25ebae8a5f3d9203d63b.bundle.js.map